      ...
      <div style={{
        ...
        <div style={{ maxWidth: "640px", animation: "fadeUp 0.8s ease forwards" }}>
          ...
          <div style={{
            ...
            Stage académique chez HR Skills
          </div>
          ...
          <p style={{
            ...
            Inscrivez-vous, déposez vos documents académiques, réglez les frais de votre stage et suivez la validation de votre dossier en temps réel — tout depuis votre téléphone ou ordinateur.
          </p>
          ...
          <div style={{ display: "flex", gap: "14px", flexWrap: "wrap" }}>
            <Link to="/register" className="hero-btn-primary" style={{
              ...
              Démarrer mon stage <FiArrowRight />
            </Link>
